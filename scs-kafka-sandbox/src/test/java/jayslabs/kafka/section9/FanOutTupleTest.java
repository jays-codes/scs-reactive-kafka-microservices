package jayslabs.kafka.section9;
...
public class FanOutTupleTest extends AbstractIntegrationTest{

    private static final Logger log = LoggerFactory.getLogger(FanOutTupleTest.class);
